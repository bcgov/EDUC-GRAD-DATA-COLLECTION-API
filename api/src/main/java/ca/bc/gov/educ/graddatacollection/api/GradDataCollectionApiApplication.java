...
/**
 * The Grad Data Collection api application.
 *
 * @author OM
 */
...
@EnableRetry
public class GradDataCollectionApiApplication {
  ...
  public static void main(final String[] args) {
    SpringApplication.run(GradDataCollectionApiApplication.class, args);
  }
