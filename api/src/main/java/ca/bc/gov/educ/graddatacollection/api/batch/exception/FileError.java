...
public enum FileError {
  ...
  FINAL_LETTER_GRADE_EXCEL("Final Letter Grade cannot be more than 2 digits. Review the data on line $?"),
  NO_OF_CREDITS_EXCEL("Number of Credits cannot be more than 1 digits. Review the data on line $?"),
  BIRTHDATE_FORMAT_EXCEL("Birthdate must be in the format YYYYMMDD. Review the data on line $?"),
  SESSION_DATE_FORMAT_EXCEL("Can only report courses in the <YYYY current year>07 or <YYYY current year>08 sessions. Review the data on line $?"),
