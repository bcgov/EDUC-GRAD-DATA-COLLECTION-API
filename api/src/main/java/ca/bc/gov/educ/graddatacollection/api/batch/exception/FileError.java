...
public enum FileError {
  ...
  COURSE_CODE_IN_EXCEL("Course code cannot be longer than 5 characters. Review the data on line $?."),
  COURSE_LEVEL_IN_EXCEL("Course level cannot be longer than 3 characters. Review the data on line $?."),
