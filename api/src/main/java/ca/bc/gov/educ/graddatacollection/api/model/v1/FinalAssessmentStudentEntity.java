...
@Data
@Entity
@Table(name = "FINAL_ASSESSMENT_STUDENT")
@DynamicUpdate
public class FinalAssessmentStudentEntity {
  ...
  private FinalIncomingFilesetEntity incomingFileset;
  ...
  @EqualsAndHashCode.Exclude
  @ToString.Exclude
  @OneToMany(mappedBy = "assessmentStudent", fetch = FetchType.EAGER, cascade = CascadeType.ALL, orphanRemoval = true, targetEntity = FinalAssessmentStudentValidationIssueEntity.class)
  Set<FinalAssessmentStudentValidationIssueEntity> assessmentStudentValidationIssueEntities;

  public Set<FinalAssessmentStudentValidationIssueEntity> getAssessmentStudentValidationIssueEntities() {
    if (this.assessmentStudentValidationIssueEntities == null) {
      this.assessmentStudentValidationIssueEntities = new HashSet<>();
    }
    return this.assessmentStudentValidationIssueEntities;
  }
}
