...
@DynamicUpdate
@Entity
@Table(name = "FINAL_ASSESSMENT_STUDENT_VALIDATION_ISSUE")
@JsonIgnoreProperties(ignoreUnknown = true)
public class FinalAssessmentStudentValidationIssueEntity {
  @Id
  ...
  @ManyToOne(optional = false, targetEntity = FinalAssessmentStudentEntity.class)
  @JoinColumn(name = "ASSESSMENT_STUDENT_ID", referencedColumnName = "ASSESSMENT_STUDENT_ID", updatable = false)
  FinalAssessmentStudentEntity assessmentStudent;
