...
@Data
@Entity
@Table(name = "FINAL_COURSE_STUDENT")
@DynamicUpdate
public class FinalCourseStudentEntity {
  ...
  @EqualsAndHashCode.Exclude
  @ToString.Exclude
  @OneToMany(mappedBy = "courseStudent", fetch = FetchType.EAGER, cascade = CascadeType.ALL, orphanRemoval = true, targetEntity = FinalCourseStudentValidationIssueEntity.class)
  Set<FinalCourseStudentValidationIssueEntity> courseStudentValidationIssueEntities;

  public Set<FinalCourseStudentValidationIssueEntity> getCourseStudentValidationIssueEntities() {
    if (this.courseStudentValidationIssueEntities == null) {
      this.courseStudentValidationIssueEntities = new HashSet<>();
    }
    return this.courseStudentValidationIssueEntities;
  }
}
