...
@DynamicUpdate
@Entity
@Table(name = "FINAL_COURSE_STUDENT_VALIDATION_ISSUE")
@JsonIgnoreProperties(ignoreUnknown = true)
public class FinalCourseStudentValidationIssueEntity {
  @Id
  ...
  @ManyToOne(optional = false, targetEntity = FinalCourseStudentEntity.class)
  @JoinColumn(name = "COURSE_STUDENT_ID", referencedColumnName = "COURSE_STUDENT_ID", updatable = false)
  FinalCourseStudentEntity courseStudent;
