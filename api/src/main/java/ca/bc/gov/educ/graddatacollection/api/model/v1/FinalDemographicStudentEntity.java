...
@Data
@Entity
@Table(name = "FINAL_DEMOGRAPHIC_STUDENT")
@DynamicUpdate
public class FinalDemographicStudentEntity {
  ...
  @EqualsAndHashCode.Exclude
  @ToString.Exclude
  @OneToMany(mappedBy = "demographicStudent", fetch = FetchType.EAGER, cascade = CascadeType.ALL, orphanRemoval = true, targetEntity = FinalDemographicStudentValidationIssueEntity.class)
  Set<FinalDemographicStudentValidationIssueEntity> demographicStudentValidationIssueEntities;

  public Set<FinalDemographicStudentValidationIssueEntity> getDemographicStudentValidationIssueEntities() {
