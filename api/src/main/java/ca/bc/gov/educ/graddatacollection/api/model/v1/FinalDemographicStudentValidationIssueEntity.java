...
@DynamicUpdate
@Entity
@Table(name = "FINAL_DEMOGRAPHIC_STUDENT_VALIDATION_ISSUE")
@JsonIgnoreProperties(ignoreUnknown = true)
public class FinalDemographicStudentValidationIssueEntity {
  @Id
  ...
  @ManyToOne(optional = false, targetEntity = FinalDemographicStudentEntity.class)
  @JoinColumn(name = "DEMOGRAPHIC_STUDENT_ID", referencedColumnName = "DEMOGRAPHIC_STUDENT_ID", updatable = false)
  FinalDemographicStudentEntity demographicStudent;
