...
public enum AssessmentStudentValidationIssueTypeCode {
  ...
  DEM_DATA_MISSING("DEM_DATA_MISSING", "The student's assessment data cannot be processed because they are missing from the DEM file."),
  DEM_DATA_XAM_DATA_SURNAME_MISMATCH("DEM_DATA_XAM_DATA_SURNAME_MISMATCH", "The student's assessment data cannot be processed because their Surname in the XAM file does not match the DEM file."),
  DEM_DATA_XAM_DATA_LOCALID_MISMATCH("DEM_DATA_XAM_DATA_LOCALID_MISMATCH", "The student's assessment data cannot be processed because their Local ID in the XAM file does not match the DEM file."),
  ...
  COURSE_SESSION_DATE_NOT_UNAPPROVED_SESSION("COURSE_SESSION_DATE_NOT_UNAPPROVED_SESSION", "%s%s is not a valid Assessment session. Check that a valid assessment session date was reported. This registration cannot be updated."),
  ...
  ASSESSMENT_HAS_DEM_BLOCKING("ASSESSMENT_HAS_DEM_BLOCKING", "Error(s) on the DEM file for this student are preventing the assessment from being stored in GRAD."),
  ERROR_IN_DEM_FILE("ERROR_IN_DEM_FILE", "An error in the DEM file for this student is preventing the processing of their assessment data.")
  ;
