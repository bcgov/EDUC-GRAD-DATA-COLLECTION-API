...
public enum AssessmentValidationRulesDependencyMatrix {
    ...
    ENTRY5("V322", new String[]{AssessmentStudentValidationIssueTypeCode.DEM_ISSUE.getCode(), AssessmentStudentValidationIssueTypeCode.DEM_DATA_MISSING.getCode(), AssessmentStudentValidationIssueTypeCode.COURSE_SESSION_INVALID.getCode()});
