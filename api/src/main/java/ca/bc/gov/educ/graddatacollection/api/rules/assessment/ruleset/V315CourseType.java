 ...
 *  |------|----------|-----------------------------------------------------------------------|--------------|
 *  | V315 | WARNING  |  Course type value is ignored and must be blank                       |--------------|
 *
 */
@Component
@Slf4j
...
public class V315CourseType implements AssessmentValidationBaseRule {
    ...
    public List<AssessmentStudentValidationIssue> executeValidation(StudentRuleData studentRuleData) {
        ...
        if (StringUtils.isNotBlank(student.getCourseType())){
            ...
            errors.add(createValidationIssue(StudentValidationIssueSeverityCode.WARNING, ValidationFieldCode.COURSE_TYPE, AssessmentStudentValidationIssueTypeCode.COURSE_TYPE_NOT_BLANK, AssessmentStudentValidationIssueTypeCode.COURSE_TYPE_NOT_BLANK.getMessage()));
        }
        return errors;
    }
