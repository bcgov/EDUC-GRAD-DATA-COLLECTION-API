...
public enum CourseStudentValidationIssueTypeCode {
  ...
  DEM_DATA_CRS_DATA_MISMATCH("DEM_DATA_CRS_DATA_MISMATCH", "The student’s registration data cannot be processed because their Surname in the CRS file does not match the DEM file."),
