...
public enum CourseStudentValidationIssueTypeCode {
  ...
  FINAL_LETTER_GRADE_PERCENT_SHOULD_NOT_BE_PROVIDED("FINAL_LETTER_GRADE_PERCENT_SHOULD_NOT_BE_PROVIDED", "An final percent should not be provided for the submitted final letter grade. This course cannot be updated."),
  FINAL_LETTER_GRADE_PERCENT_REQUIRED("FINAL_LETTER_GRADE_PERCENT_REQUIRED", "An final percent is required for the submitted final letter grade. This course cannot be updated."),
