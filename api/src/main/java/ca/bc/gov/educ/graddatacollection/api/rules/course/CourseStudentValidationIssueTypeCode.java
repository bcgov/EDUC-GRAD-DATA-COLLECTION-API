...
public enum CourseStudentValidationIssueTypeCode {
  ...
  DEM_DATA_CRS_DATA_SURNAME_MISMATCH("DEM_DATA_CRS_DATA_SURNAME_MISMATCH", "The student’s registration data cannot be processed because their Surname in the CRS file does not match the DEM file."),
  DEM_DATA_CRS_DATA_LOCALID_MISMATCH("DEM_DATA_CRS_DATA_LOCALID_MISMATCH", "The student’s registration data cannot be processed because their Local ID in the CRS file does not match the DEM file."),
