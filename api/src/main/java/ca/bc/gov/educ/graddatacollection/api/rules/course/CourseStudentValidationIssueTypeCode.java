...
public enum CourseStudentValidationIssueTypeCode {
  ...
  DEM_DATA_MISSING("DEM_DATA_MISSING", "The student's course data cannot be processed because they are missing from the DEM file."),
  DEM_DATA_CRS_DATA_SURNAME_MISMATCH("DEM_DATA_CRS_DATA_SURNAME_MISMATCH", "The student's course data cannot be processed because their Surname in the CRS file does not match the DEM file."),
  DEM_DATA_CRS_DATA_LOCALID_MISMATCH("DEM_DATA_CRS_DATA_LOCALID_MISMATCH", "The student's course data cannot be processed because their Local ID in the CRS file does not match the DEM file."),
  ...
  COURSE_RECORD_EXISTS("COURSE_RECORD_EXISTS", "A student course has been submitted as \"W\" (withdrawal) but has an associated exam record (has completed/final course percentage, completed/final course letter exam, or exam percentage). This course cannot be deleted."),
  ...
  INTERIM_LETTER_GRADE_PERCENT_SHOULD_NOT_BE_PROVIDED("INTERIM_LETTER_GRADE_PERCENT_SHOULD_NOT_BE_PROVIDED", "An interim percent should not be provided for the submitted interim letter grade. This course cannot be updated."),
  INTERIM_LETTER_GRADE_PERCENT_REQUIRED("INTERIM_LETTER_GRADE_PERCENT_REQUIRED", "An interim percent is required for the submitted interim letter grade. This course cannot be updated."),
  INTERIM_LETTER_GRADE_PERCENT_OUT_OF_RANGE("INTERIM_LETTER_GRADE_PERCENT_OUT_OF_RANGE", "The interim percent does not fall within the required range for the reported interim letter grade. This course cannot be updated."),
  ...
  FINAL_LETTER_GRADE_PERCENT_SHOULD_NOT_BE_PROVIDED("FINAL_LETTER_GRADE_PERCENT_SHOULD_NOT_BE_PROVIDED", "A final percent should not be provided for the submitted final letter grade. This course cannot be updated."),
  FINAL_LETTER_GRADE_PERCENT_REQUIRED("FINAL_LETTER_GRADE_PERCENT_REQUIRED", "A final percent is required for the submitted final letter grade. This course cannot be updated."),
  FINAL_LETTER_GRADE_PERCENT_OUT_OF_RANGE("FINAL_LETTER_GRADE_PERCENT_OUT_OF_RANGE", "The final percent does not fall within the required range for the reported final letter grade. This course cannot be updated."),
