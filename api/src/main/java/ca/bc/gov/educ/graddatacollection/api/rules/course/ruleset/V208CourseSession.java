...
public class V208CourseSession implements CourseValidationBaseRule {
    ...
    public List<CourseStudentValidationIssue> executeValidation(StudentRuleData studentRuleData) {
        ...
        if (courseRulesService.checkIfStudentHasDuplicateInFileset(student.getPen(), student.getCourseCode(), student.getCourseMonth(), student.getCourseYear(), student.getCourseLevel())) {
            ...
            errors.add(createValidationIssue(StudentValidationIssueSeverityCode.ERROR, ValidationFieldCode.COURSE_SESSION, CourseStudentValidationIssueTypeCode.COURSE_SESSION_DUPLICATE, CourseStudentValidationIssueTypeCode.COURSE_SESSION_DUPLICATE.getMessage()));
        }
