...
public enum DemographicStudentValidationIssueTypeCode {
  ...
  STUDENT_PROGRAM_GRAD_REQUIREMENT_YEAR_NULL_GRAD("STUDENT_PROGRAM_GRAD_REQUIREMENT_YEAR_NULL_GRAD", "Student has been submitted with a blank graduation program and has already graduated. The student's graduation program will not be updated."),
