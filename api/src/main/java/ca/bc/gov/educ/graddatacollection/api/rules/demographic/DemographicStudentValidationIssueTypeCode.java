...
public enum DemographicStudentValidationIssueTypeCode {
  ...
  STUDENT_PEN_BLANK("STUDENTPENBLANK", "PEN is blank so the student record cannot be updated. Ensure the correct PEN appears in system data file extracts."),
  ...
  GRADE_AG_INVALID("GRADEAGINVALID", "Student is being reported on the Adult Graduation program (1950) so grade level should be AD or AN."),
  GRADE_OG_INVALID("GRADEOGINVALID", "Student is being reported in grade level AD or AN but is not on the Adult Graduation program (1950)."),
