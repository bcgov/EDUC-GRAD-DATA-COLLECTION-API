...
public enum DemographicStudentValidationIssueTypeCode {
  ...
  STUDENT_STATUS_SCHOOL_OF_RECORD_MISMATCH("STUDENTSTATUSSCHOOLOFRECORDMISMATCH", "Student is assigned to another School of Record in GRAD, so the submitted \"T\" status (withdrawal) is ignored. No action needed unless your school is the current SOR."),
