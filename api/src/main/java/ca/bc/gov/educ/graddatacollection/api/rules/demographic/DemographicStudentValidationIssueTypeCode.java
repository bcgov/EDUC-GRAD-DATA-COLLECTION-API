...
public enum DemographicStudentValidationIssueTypeCode {
  ...
  STUDENT_PEN_NOT_FOUND("STUDENTPENNOTFOUND", "Student PEN is not valid so the student record cannot be updated. Correct the PEN in your system or request an update through the Secure Messaging [add link] inbox."),
  ...
  GRADE_INVALID("GRADEINVALID", "Invalid student grade level. No information in student's DEM file will be processed."),
  ...
  SCCP_INVALID_DATE("SCCPINVALIDDATE", "Invalid SCCP completion date. Must be blank or YYYYMMDD. No information in student's DEM file will be processed."),
  ...
  STUDENT_PROGRAM_CODE_INVALID("STUDENTPROGRAMCODEINVALID", "Invalid program code. The student's DEM file will not be processed."),
  STUDENT_PROGRAM_SCHOOL_CATEGORY_CODE_INVALID("STUDENTPROGRAMSCHOOLCATEGORYCODEINVALID", "1950 and SCCP are not valid program codes for offshore schools. No information in student's DEM file will be processed."),
  STUDENT_PROGRAM_GRAD_REQUIREMENT_YEAR_INVALID("STUDENTPROGRAMGRADREQUIREMENTYEARINVALID", "Invalid graduation program code. The student's DEM file will not be processed."),
  STUDENT_PROGRAM_GRAD_REQUIREMENT_YEAR_NULL("STUDENTPROGRAMGRADREQUIREMENTYEARNULL", "The student must be reported on a graduation program. No information in student's DEM file will be processed."),
