...
public enum DemographicValidationRulesDependencyMatrix {
    ENTRY1("D09", new String[]{STUDENT_PEN_NOT_FOUND.getCode()}),
    ...
    ENTRY9("D17", new String[]{STUDENT_PEN_NOT_FOUND.getCode(), STUDENT_PROGRAM_GRAD_REQUIREMENT_YEAR_INVALID.getCode()}),
    ...
    ENTRY14("D22", new String[]{STUDENT_PEN_NOT_FOUND.getCode(), STUDENT_STATUS_INVALID.getCode()}),
    ...
    ENTRY17("D25", new String[]{STUDENT_PROGRAM_GRAD_REQUIREMENT_YEAR_INVALID.getCode(), SCCP_INVALID_DATE.getCode()}),
