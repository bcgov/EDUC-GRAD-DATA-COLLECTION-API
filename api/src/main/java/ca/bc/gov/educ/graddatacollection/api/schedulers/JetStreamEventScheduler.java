...
/**
 * This class is responsible to check the GDC_EVENTS_TOPIC table periodically and publish messages to Jet Stream, if some them are not yet published
...
public class JetStreamEventScheduler {
   ...
   */
  public JetStreamEventScheduler(final GDCEventRepository eventRepository, Publisher publisher, final ChoreographEventHandler choreographer) {
