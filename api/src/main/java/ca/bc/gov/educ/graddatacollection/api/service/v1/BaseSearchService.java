...
import ca.bc.gov.educ.graddatacollection.api.exception.InvalidParameterException;
import ca.bc.gov.educ.graddatacollection.api.filter.BaseFilterSpecs;
...
import ca.bc.gov.educ.graddatacollection.api.util.TransformUtil;
    ...
    if (!criteriaList.isEmpty()) {
      ...
      for (SearchCriteria criteria : criteriaList) {
        if (criteria.getKey() != null && criteria.getOperation() != null && criteria.getValueType() != null) {
          ...
          if(StringUtils.isNotBlank(criteria.getValue()) && TransformUtil.isUppercaseField(ErrorFilesetStudentEntity.class, criteria.getKey())) {
