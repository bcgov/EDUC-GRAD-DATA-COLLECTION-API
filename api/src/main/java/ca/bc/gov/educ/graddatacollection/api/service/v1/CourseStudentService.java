...
public class CourseStudentService {
    ...
    public void updateStudentStatus(final CourseStudentUpdate courseStudentUpdate, final SchoolStudentStatus status) {
        List<CourseStudentEntity> currentStudentEntity = this.this.courseRulesService.findByIncomingFilesetIDAndPenAndStudentStatusCode(UUID.fromString(courseStudentUpdate.getIncomingFilesetID()), courseStudentUpdate.getPen());
