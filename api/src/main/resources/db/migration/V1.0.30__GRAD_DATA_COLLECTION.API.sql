CREATE TABLE FINAL_INCOMING_FILESET (
   ...
   CONSTRAINT FINAL_INCOMING_FILESET_ID_PK PRIMARY KEY (INCOMING_FILESET_ID),
   CONSTRAINT FK_FINAL_INCOMING_FILESET_FILESET_STATUS_CODE FOREIGN KEY (FILESET_STATUS_CODE) REFERENCES FILE_STATUS_CODE(FILE_STATUS_CODE),
   CONSTRAINT FK_FINAL_REPORTING_PERIOD_ID FOREIGN KEY (REPORTING_PERIOD_ID) REFERENCES REPORTING_PERIOD(REPORTING_PERIOD_ID)
);
