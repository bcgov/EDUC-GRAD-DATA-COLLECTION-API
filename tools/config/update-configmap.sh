...
SCHEDULED_JOBS_PROCESS_LOADED_GRAD_STUDENTS_CRON="0/2 * * * * *"
SCHEDULED_JOBS_PROCESS_LOADED_GRAD_STUDENTS_CRON_LOCK_AT_LEAST_FOR="1700ms"
SCHEDULED_JOBS_PROCESS_LOADED_GRAD_STUDENTS_CRON_LOCK_AT_MOST_FOR="1900ms"
INCOMING_FILESET_STALE_IN_MINUTES="15"
